      ...
      <section className="about py-lg-4 py-md-3 py-sm-3 py-3" id="about">
        <div className="container py-lg-5 py-md-5 py-sm-4 py-4">
          ...
          <div className="row banner-below-w3l">
            ...
            <div className="col-lg-4 col-md-6 col-sm-6 mt-3 text-center banner-agile-flowers">
              <img src="images/a5.jpg" className="img-thumbnail" alt="" />
              <div className="banner-right-icon">
                <h4 className="pt-3">Gift Toys</h4>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-6 mt-3 text-center banner-agile-flowers">
              <img src="images/a6.jpg" className="img-thumbnail" alt="" />
              <div className="banner-right-icon">
            ...
            <ul id="flexiselDemo1">
              <li>
                <div className="agileinfo_port_grid">
                  <img src="images/a1.jpg" alt="" className="img-fluid" />
                  <div className="banner-right-icon">
                    <h4 className="pt-3">Soft Toys</h4>
                  </div>
              ...
              <li>
                <div className="agileinfo_port_grid">
                  <img src="images/a2.jpg" alt="" className="img-fluid" />
                  <div className="banner-right-icon">
                    <h4 className="pt-3">Soft Toys</h4>
                  </div>
                  <div className="outs_more-buttn">
              ...
              <li>
                <div className="agileinfo_port_grid">
                  <img src="images/a3.jpg" alt=" " className="img-fluid" />
                  <div className="banner-right-icon">
                    <h4 className="pt-3">Soft Toys</h4>
                  </div>
                  <div className="outs_more-buttn">
              ...
              <li>
                <div className="agileinfo_port_grid ">
                  <img src="images/a4.jpg" alt="" className="img-fluid" />
                  <div className="banner-right-icon">
                    <h4 className="pt-3">Soft Toys</h4>
                  </div>
                  <div className="outs_more-buttn">
              ...
              <li>
                <div className="agileinfo_port_grid">
                  <img src="images/a5.jpg" alt=" " className="img-fluid" />
                  <div className="banner-right-icon">
                    <h4 className="pt-3">Soft Toys</h4>
                  </div>
                  <div className="outs_more-buttn">
              ...
              <li>
                <div className="agileinfo_port_grid ">
                  <img src="images/a6.jpg" alt="" className="img-fluid" />
                  <div className="banner-right-icon">
                    <h4 className="pt-3">Soft Toys</h4>
                  </div>
                  <div className="outs_more-buttn">
